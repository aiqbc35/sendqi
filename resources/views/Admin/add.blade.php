        ...
        <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="/admin/video/addHalt" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">整片</label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{isset($info->length) ? $info->length : 0}}" name="length" placeholder="length">
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
